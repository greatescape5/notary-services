...
> SEO town pages grouped by county (Spokane, Whitman, Stevens, Pend Oreille), plus
> layout ideas to model from the reference `web screen shot.jpg` (value band,
> services checklist, and a "We Service" county map).
